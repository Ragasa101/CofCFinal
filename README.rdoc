...
-Use email as long in credentials, since email is unique
-Ability to register new chefs to use the app
-Ablity to display chefs profile
-Ability to list chefs using the app 
-Ability for chefs to log in and log out of the aoo
-Restric actions liek create recipe, edit recipe and liek features to logged in chefs only
...
- summary must be ebtween 10 characters and less than 150 characters
